...
let material = make_material 
  ~init:(fun () -> 
    ...
    new textured_phong_material ~textures:[car_exterior_texture] ~alpha:1.0 ~ambient_coeff:0.3 ~specular_expo:32 ~light_position:(vec3 0.0 0.0 0.0) ~light_color:(vec3 1.0 1.0 1.0) ~light_intensity:10.0)
